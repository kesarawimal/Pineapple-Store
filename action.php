...
if (isset($_POST["Common"])) {
	...
	if (isset($_POST["getCartItem"])) {
		...
		if (mysqli_num_rows($query) > 0) {
			...
			?>
				<a style="float:left;" href="cart.php" class="btn btn-warning">Edit&nbsp;&nbsp;<span class="glyphicon glyphicon-edit"></span></a>
				<a style="float:right;" href="cart.php" class="btn btn-danger">CheckOut&nbsp;&nbsp;<span class="glyphicon glyphicon-check"></span></a>
			<?php
			exit();
		}
	}
